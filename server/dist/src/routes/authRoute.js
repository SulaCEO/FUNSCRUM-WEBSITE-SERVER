...
const authRouter = () => {
    ...
    router.get('/:id/delete', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const deletedUserToken = yield db.query('delete from customer_token where customer_id = $1', [req.params.id]);
        const deletedUser = yield db.query('delete from customer where id = $1', [req.params.id]);
